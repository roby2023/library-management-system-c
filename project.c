...
typedef struct
{
    unsigned int books_id; //Eita obossoi Integer data hobe
    char bookName[MAX_BOOK_NAME];//Eita obossoi Character data hobe
    char authorName[MAX_AUTHOR_NAME];//Eita obossoi Character data hobe
    char studentName[MAX_STUDENT_NAME];//Eita obossoi Character data hobe
    char studentAddr[MAX_STUDENT_ADDRESS];//Eita obossoi Character data hobe
    Date bookIssueDate;//Eita obossoi Integer data hobe
} s_BooksInfo;
void printMessageCenter(const char* message)
{
    int len =0;
    int pos = 0;
    //koto gula space hobe oita print korbe
...
// Function ta leap year kina check korbe.
//Function ta leap year hole 1 return korbe
...
//given date jodi valid hoy 1 return korbe.
...
void addBookInDataBase()
{
    ...
    do
    {
        //user er kach theke date year,month and day nibe
...
void searchBooks()
{
    ...
    //ekhane shob boi er details rakhbe
...
void init()
{
    FILE *fp = NULL;
    int status = 0;
    const char defaultUsername[] ="roby\n";
    const char defaultPassword[] ="roby\n";
    sFileHeader fileHeaderInfo = {0};
